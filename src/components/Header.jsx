...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-blue-500 rounded-1g px-6 md:px-10 lg:px-20'>
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                ...
                <p>Simple browse through our extensive list trusted doctors,<br className='hidden sm:block'/> schedule your appointment hassle-free. </p>
            </div>
